...
using namespace std;
/*
Направете абстрактен клас Музикален Инструмент с член-променливи име, година на производство и тип(струнен, клавишен...).Добавете абстрактен метод printInfo(), извеждащ информацията за инструмента.
